...
interface IUserInfoMobile {
  user: UserData;
}

const UserInfoMobile: FC<IUserInfoMobile> = ({ user: { data } }) => {
  ...
  return (
    ...
    >
      ...
      <div className="w-full flex flex-col items-center gap-[10px]">
        <Stack direction="column" className="justify-between items-center w-full">
        ...
        <Stack direction="column" sx={{ gap: "15px", width: "100%", alignItems: "center" }}>
          <Typography variant="body2" sx={{ color: "primary" }}>
        ...
        <Typography variant="body2" sx={{ textAlign: "center" }}>
          {data.bio ? `${t("bio")}: ${data.bio}` : `${t("withoutBio")}`}
        </Typography>
